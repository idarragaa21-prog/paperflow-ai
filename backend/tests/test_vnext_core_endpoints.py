...
class TestVNextCoreFlow:
    async def test_extraction_matrix_to_meta_run_pipeline(
        ...
        self.monkeypatch.setattr(
            meta_runs_service.httpx, "AsyncClient", DummyAsyncClientPost
        )
        ...
        assert any(
            item.startswith("forest_") or item.startswith("figure_")
