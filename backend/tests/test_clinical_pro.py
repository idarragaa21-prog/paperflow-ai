...
async def load_clinical_sheet_or_skip() -> ClinicalSheet:
    async with async_session_maker() as db:
        ...
        if sheet is None:
            pytest.skip(f"ClinicalSheet fixture {SHEET_ID} is not seeded in the current test database")
        return sheet
...
async def test_json_schema_valid():
    ...
    sheet = await load_clinical_sheet_or_skip()
