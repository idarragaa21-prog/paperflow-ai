...
async def create_presentation(
    ...
    # ⚡ Bolt Optimization: Batch fetch papers to prevent N+1 queries during validation
    # This reduces DB roundtrips from O(n) to O(1), improving creation latency for multi-paper presentations.
