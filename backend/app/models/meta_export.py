...
from sqlalchemy import DateTime, ForeignKey, String, Text, Uuid, Index, func
...
class MetaExport(Base):
    ...
    batch_id: Mapped[uuid.UUID | None] = mapped_column(Uuid(as_uuid=True, native_uuid=True), nullable=True)
