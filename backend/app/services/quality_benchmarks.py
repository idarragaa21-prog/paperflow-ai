...
# Bolt Optimization: Pre-compile regexes at the module level to avoid
# repeated compilation and cache lookup overhead inside heavily executed functions.
...
def normalize_text(value: str | None) -> str:
    ...
    lowered = _NON_ALPHANUM_RE.sub(" ", lowered)
    lowered = _MULTI_SPACE_RE.sub(" ", lowered).strip()
    return lowered
