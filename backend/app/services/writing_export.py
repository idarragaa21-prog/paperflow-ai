...
# PERFORMANCE OPTIMIZATION: Hoisted regex to module level.
# `_add_inline_runs` is called frequently (once per paragraph).
# Hoisting avoids repeated `re` cache dictionary lookups.
