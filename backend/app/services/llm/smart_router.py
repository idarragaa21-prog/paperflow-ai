...
from app.services.llm.provider_adapters import LLMResponse, get_adapter, LLMRequest
    ...
    async def route(
        ...
        *,
        ...
        if model_override:
            ...
            req = LLMRequest(prompt=prompt, system=system, temperature=temperature, max_tokens=max_tokens, json_mode=json_mode)
