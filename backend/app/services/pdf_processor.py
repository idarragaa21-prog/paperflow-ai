        ...
        for page_number, page in enumerate(doc, start=1):
            ...
            for block in raw.get("blocks", []):
                ...
                if (
                    ...
                    if block_text.isupper() or _NUMBERED_HEADING_RE.match(block_text):
                        headings.append(
                            {
                                "heading": block_text,
                                "page_number": page_number,
...
# Pre-compiled for performance to avoid internal cache lookups during heavy PDF processing
