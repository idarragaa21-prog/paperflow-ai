...
# ---- CONTENT IMAGES (swap these for your article's figures / illustrations) ----
FIG = {
    "fig1": data_uri("example_assets/fig1.jpg"),
    "fig4": data_uri("example_assets/fig4.jpg"),
    "fig3": data_uri("example_assets/fig3.jpg"),
    "fig5": data_uri("example_assets/fig5.jpg"),
}
ANAT = data_uri("example_assets/anat_mortise.png")
LIG  = data_uri("example_assets/anat_ligaments.png")
from orn import dotgrid, bulb_magnifier, diamond_rule, laurel_crest, ankle_anatomy, NAVY, NAVY2, GOLD, GOLD2

OUT=_os.path.join(HERE, "out"); TOTAL=13
os.makedirs(OUT, exist_ok=True)
FACES=open(_os.path.join(HERE,'montserrat_faces.txt')).read()
