...
## 2024-05-24 - Prevent user enumeration via timing attack
**Vulnerability:** User enumeration timing attack in login endpoint.
**Learning:** Checking the password hash only when a user is found causes a noticeable timing difference when a user doesn't exist, leaking information.
