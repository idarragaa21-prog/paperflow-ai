...
describe('SettingsPage', () => {
  ...
  it('blocks password change when confirmation does not match', async () => {
    ...
    await userEvent.type(passwordInputs[0] as Element, 'current-password');
    await userEvent.type(passwordInputs[1] as Element, 'new-password');
    await userEvent.type(passwordInputs[2] as Element, 'different-password');
