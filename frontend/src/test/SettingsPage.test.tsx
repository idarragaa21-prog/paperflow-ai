...
describe('SettingsPage', () => {
  ...
  it('blocks password change when confirmation does not match', async () => {
    ...
    await userEvent.type(passwordInputs[0] as HTMLElement, 'current-password');
    await userEvent.type(passwordInputs[1] as HTMLElement, 'new-password');
    await userEvent.type(passwordInputs[2] as HTMLElement, 'different-password');
