...
describe('SettingsPage', () => {
  ...
  it('blocks password change when confirmation does not match', async () => {
    ...
    await userEvent.type(inputs[0] as HTMLElement, 'current-password');
    await userEvent.type(inputs[1] as HTMLElement, 'new-password');
    await userEvent.type(inputs[2] as HTMLElement, 'different-password');
