...
describe('SettingsPage', () => {
  ...
  it('blocks password change when confirmation does not match', async () => {
    ...
    await userEvent.type(passwordInputs[0] as HTMLInputElement, 'current-password');
    await userEvent.type(passwordInputs[1] as HTMLInputElement, 'new-password');
    await userEvent.type(passwordInputs[2] as HTMLInputElement, 'different-password');
