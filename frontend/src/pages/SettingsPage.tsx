        ...
        <>
          ...
          <div className="rc-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                <label className="rc-kicker" htmlFor="profile-email" style={{ display: 'block' }}>Email</label>
                <input id="profile-email" className="rc-input" value={user?.email || ''} readOnly style={{ opacity: 0.6 }} />
              </div>
              <div>
                <label className="rc-kicker" htmlFor="profile-fullname" style={{ display: 'block' }}>Full name</label>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10 }}>
                <div>
                  <label className="rc-kicker" htmlFor="profile-affiliation" style={{ display: 'block' }}>Affiliation</label>
                  <input
                ...
                <div>
                  <label className="rc-kicker" htmlFor="profile-orcid" style={{ display: 'block' }}>ORCID</label>
                  <input
                    id="profile-orcid"
                    className="rc-input"
                    value={orcid}
                ...
                <div>
                  <label className="rc-kicker" htmlFor="profile-default-language" style={{ display: 'block' }}>Default language</label>
                  <select
                    id="profile-default-language"
                    className="rc-select"
              ...
              <div>
                <label className="rc-kicker" htmlFor="profile-signature" style={{ display: 'block' }}>Signature (markdown)</label>
                <textarea
