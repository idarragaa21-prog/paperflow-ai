        ...
        <>
          ...
          <div className="rc-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                <label className="rc-kicker" htmlFor="profile-email">Email</label>
                <input id="profile-email" className="rc-input" value={user?.email || ''} readOnly style={{ opacity: 0.6 }} />
              </div>
              <div>
                <label className="rc-kicker" htmlFor="profile-fullname">Full name</label>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10 }}>
                <div>
                  <label className="rc-kicker" htmlFor="profile-affiliation">Affiliation</label>
                  <input
                ...
                <div>
                  <label className="rc-kicker" htmlFor="profile-orcid">ORCID</label>
                  <input
                    id="profile-orcid"
                    className="rc-input"
                    value={orcid}
                ...
                <div>
                  <label className="rc-kicker" htmlFor="profile-language">Default language</label>
                  <select
                    id="profile-language"
                    className="rc-select"
              ...
              <div>
                <label className="rc-kicker" htmlFor="profile-signature">Signature (markdown)</label>
                <textarea
          ...
          <div className="rc-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                <label className="rc-kicker" htmlFor="current-password">Current password</label>
                <input id="current-password" className="rc-input" type="password" value={currentPw} onChange={(e) => setCurrentPw(e.target.value)} />
              </div>
              <div>
                <label className="rc-kicker" htmlFor="new-password">New password (min 8 chars)</label>
                <input id="new-password" className="rc-input" type="password" value={newPw} onChange={(e) => setNewPw(e.target.value)} />
              </div>
              <div>
                <label className="rc-kicker" htmlFor="confirm-password">Confirm new password</label>
