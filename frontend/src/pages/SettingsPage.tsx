        ...
        <>
          ...
          <div className="rc-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                <label htmlFor="profile-email" className="rc-kicker" style={{ display: 'block' }}>Email</label>
                <input id="profile-email" className="rc-input" value={user?.email || ''} readOnly style={{ opacity: 0.6 }} />
              </div>
              <div>
                <label htmlFor="profile-fullname" className="rc-kicker" style={{ display: 'block' }}>Full name</label>
                <input id="profile-fullname" className="rc-input" value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="Your name" />
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10 }}>
                <div>
                  <label htmlFor="profile-affiliation" className="rc-kicker" style={{ display: 'block' }}>Affiliation</label>
                  <input
                ...
                <div>
                  <label htmlFor="profile-orcid" className="rc-kicker" style={{ display: 'block' }}>ORCID</label>
                  <input
                    id="profile-orcid"
                    className="rc-input"
                    value={orcid}
                ...
                <div>
                  <label htmlFor="profile-language" className="rc-kicker" style={{ display: 'block' }}>Default language</label>
                  <select
                    id="profile-language"
                    className="rc-select"
              ...
              <div>
                <label htmlFor="profile-signature" className="rc-kicker" style={{ display: 'block' }}>Signature (markdown)</label>
                <textarea
          ...
          <div className="rc-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                <label htmlFor="pw-current" className="rc-kicker" style={{ display: 'block' }}>Current password</label>
                <input id="pw-current" className="rc-input" type="password" value={currentPw} onChange={(e) => setCurrentPw(e.target.value)} />
              </div>
              <div>
                <label htmlFor="pw-new" className="rc-kicker" style={{ display: 'block' }}>New password (min 8 chars)</label>
                <input id="pw-new" className="rc-input" type="password" value={newPw} onChange={(e) => setNewPw(e.target.value)} />
              </div>
              <div>
                <label htmlFor="pw-confirm" className="rc-kicker" style={{ display: 'block' }}>Confirm new password</label>
                <input id="pw-confirm" className="rc-input" type="password" value={confirmPw} onChange={(e) => setConfirmPw(e.target.value)} />
              </div>
