      ...
      {activeTab === 'general' && (
        <>
          ...
          <div className="rc-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                <label htmlFor="current-password" className="rc-kicker" style={{ display: 'block' }}>Current password</label>
                <input id="current-password" className="rc-input" type="password" value={currentPw} onChange={(e) => setCurrentPw(e.target.value)} />
              </div>
              <div>
                <label htmlFor="new-password" className="rc-kicker" style={{ display: 'block' }}>New password (min 8 chars)</label>
                <input id="new-password" className="rc-input" type="password" value={newPw} onChange={(e) => setNewPw(e.target.value)} />
              </div>
              <div>
                <label htmlFor="confirm-password" className="rc-kicker" style={{ display: 'block' }}>Confirm new password</label>
                <input id="confirm-password" className="rc-input" type="password" value={confirmPw} onChange={(e) => setConfirmPw(e.target.value)} />
              </div>
