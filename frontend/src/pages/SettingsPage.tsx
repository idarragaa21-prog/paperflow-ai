      ...
      {activeTab === 'general' && (
        <>
          ...
          <div className="rc-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                <label htmlFor="current-pw" className="rc-kicker" style={{ display: 'block' }}>Current password</label>
                <input id="current-pw" className="rc-input" type="password" value={currentPw} onChange={(e) => setCurrentPw(e.target.value)} />
              </div>
              <div>
                <label htmlFor="new-pw" className="rc-kicker" style={{ display: 'block' }}>New password (min 8 chars)</label>
                <input id="new-pw" className="rc-input" type="password" value={newPw} onChange={(e) => setNewPw(e.target.value)} />
              </div>
              <div>
                <label htmlFor="confirm-pw" className="rc-kicker" style={{ display: 'block' }}>Confirm new password</label>
