      ...
      {showCreate && (
        <div className="rc-card" style={{ borderColor:'rgba(99,102,241,0.25)',background:'rgba(99,102,241,0.02)' }}>
          ...
          <div style={{ display:'flex',flexDirection:'column',gap:12 }}>
            <div><label className="rc-kicker" htmlFor="new-project-title" style={{ display: 'block' }}>Title *</label>
            ...
            <div><label className="rc-kicker" htmlFor="new-project-area" style={{ display: 'block' }}>Clinical area</label>
