      ...
      {showCreate && (
        <div className="rc-card" style={{ borderColor:'rgba(99,102,241,0.25)',background:'rgba(99,102,241,0.02)' }}>
          ...
          <div style={{ display:'flex',flexDirection:'column',gap:12 }}>
            <div><label htmlFor="project-title" className="rc-kicker" style={{ display: 'block' }}>Title *</label>
              <input id="project-title" className="rc-input" value={newTitle} onChange={e=>setNewTitle(e.target.value)} placeholder="e.g. Distal radius fracture outcomes in older adults" autoFocus onKeyDown={e=>e.key==='Enter'&&createMut.mutate()}/></div>
            <div><label htmlFor="project-area" className="rc-kicker" style={{ display: 'block' }}>Clinical area</label>
              <input id="project-area" className="rc-input" value={newArea} onChange={e=>setNewArea(e.target.value)} placeholder="e.g. Orthopedics"/></div>
