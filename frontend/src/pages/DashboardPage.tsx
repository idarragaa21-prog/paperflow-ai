  ...
  return (
    ...
    >
      <div className="rc-card" style={{ width: 'min(480px, 96vw)', display: 'flex', flexDirection: 'column', gap: 14 }} onClick={e => e.stopPropagation()}>
        ...
        <div>
          <label htmlFor="project-title" className="rc-kicker" style={{ display: 'block' }}>Project title *</label>
          <input
            id="project-title"
            className="rc-input"
            value={title}
        ...
        <div>
          <label htmlFor="clinical-area" className="rc-kicker" style={{ display: 'block' }}>Clinical area (optional)</label>
          <input
            id="clinical-area"
            className="rc-input"
            value={area}
