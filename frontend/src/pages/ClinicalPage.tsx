      ...
      <div className="rc-workspace-grid" style={{ gridTemplateColumns: 'minmax(260px, 360px) minmax(0, 1fr)' }}>
        <section className="rc-card" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button className="rc-btn rc-btn--sm rc-btn--ghost" onClick={() => consultsQuery.refetch()} disabled={consultsQuery.isFetching} aria-label="Refresh consults" title="Refresh consults">
