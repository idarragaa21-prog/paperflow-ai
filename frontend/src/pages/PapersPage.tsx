          ...
          <div style={{ marginTop: 12 }}>
            ...
            {uploadTab === 'upload' ? (
              ...
              <div className="rc-row" style={{ alignItems: 'flex-end' }}>
                <div style={{ minWidth: 200 }}><label htmlFor="paper-doi" className="rc-kicker" style={{ display: 'block' }}>DOI</label><input id="paper-doi" className="rc-input" value={doi} onChange={e => setDoi(e.target.value)} placeholder="10.xxxx/xxxxx" /></div>
                <div style={{ width: 160 }}><label htmlFor="paper-pmid" className="rc-kicker" style={{ display: 'block' }}>PMID</label><input id="paper-pmid" className="rc-input" value={pmid} onChange={e => setPmid(e.target.value)} placeholder="12345678" /></div>
