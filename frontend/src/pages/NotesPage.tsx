        ...
        <section className="rc-product-card">
          <div className="rc-product-card__header">
            <div>
              ...
              <div className="rc-help">Filtra por título o tipo de nota y abre cualquier nota en el panel de lectura.</div>
            </div>
          ...
          <div className="rc-product-record-list">
            {filteredNotes.length === 0 ? (
              <div className="rc-empty-state">
                <div style={{ fontWeight: 800, marginBottom: 6 }}>{notes.length === 0 ? 'Todavía no hay notas' : 'No hay notas para este filtro'}</div>
                <div className="rc-help">
                  {notes.length === 0
                    ? 'Las notas aparecerán cuando los resúmenes, acciones del lector u otros módulos generen comentarios a nivel de proyecto.'
                    : 'Prueba con una búsqueda más amplia por título o tipo de nota.'}
                </div>
              </div>
            ) : (
        ...
        <section className="rc-product-card">
          {selected ? (
            ...
            <div className="rc-empty-state">
              ...
              <div className="rc-help">Elige una nota de la columna izquierda para abrir su contenido completo en una vista de lectura más tranquila.</div>
            </div>
          )}
        </section>
      </div>
