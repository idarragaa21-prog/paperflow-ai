...
const Icons = {
  ...
  AgentHub: () => <svg className="rc-nav-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="6" cy="6" r="2"/><circle cx="14" cy="6" r="2"/><circle cx="10" cy="14" r="2"/><path d="M7.5 7.5l1.5 4.5M12.5 7.5L11 12M8 14h4"/></svg>,
  ...
  return (
    <>
      ...
      <nav className="rc-nav">
        ...
        <div className="rc-nav-section">Agent workspace</div>
        <NavItem to="/agent-hub" label={t.nav.agentHub} Icon={Icons.AgentHub} onClick={onNav} />
